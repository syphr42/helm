...
# Source:
# https://github.com/longhorn/longhorn/blob/85ab7c8d9d80e244aa2f78ef1e5a1ec83b909374/scripts/lhexec

# https://github.com/longhorn/longhorn/issues/1010
# If "too many snapshots" reported in the UI, clear them out with this script
# List: lhexec <volume-name> snapshot ls
# Delete (clear a few): lhexec <volume-name> snapshot rm <snapshot-name>
# Purge: lhexec <volume-name> snapshot purge
